...
match forma_pgto:
    case 1:
        desc = valor * 0.1
        print(f"O desconto foi de {desc:.2f}, você pagará {valor- desc:.2f}")
    ...
    case 3:
        parcela = valor / 2
        print(f"Você pagará 2 x de {parcela:.2f}")
    
    case 4:
        acrescimo = valor * 0.07
        parcela = (valor + acrescimo) / 4
        print(f"O valor do produto será de {valor + acrescimo:.2f} em 4 x de {parcela:.2f}")
